...
samtools faidx SM_V9_21Feb.fa SM_V9_WSR > SM_V9_WSR_v9.fa.tmp

echo ">SM_V10_WSR" > SM_V10_WSR.fa.tmp

# remove the indel by substituting the correct sequence
sed 's/CCCTACCTACGATCAC/CCCTACTACGATCAC/' SM_V9_WSR_v9.fa.tmp | grep -v ">" | sed 's/^[[:space:]]*//g' >> SM_V10_WSR.fa.tmp

# clean up
fastaq to_fasta SM_V10_WSR.fa.tmp SM_V10_WSR.fa
...
```
- now need to fix the coordinates for the WSR annotations
